...
const mockProperties: Record<string, Property> = {
  "1": {
    ...
    media_urls: ["/images/property-2.jpg", "/images/property-3.jpg", "/images/property-4.jpg"],
  ...
  "2": {
    ...
    media_urls: ["/images/property-1.jpg", "/images/property-3.jpg", "/images/property-4.jpg"],
    features: [
      "Infinity Pool",
      "Waterfront",
      "Outdoor Lighting",
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                <div className="p-6 border-b border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-tenor-sans text-3xl text-gray-900">{formatPrice(property.price)}</h3>
                    <Badge className="bg-[#4AAEBB] text-white px-3 py-1 rounded-full">
